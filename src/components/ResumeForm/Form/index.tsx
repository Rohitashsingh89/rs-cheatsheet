...
export const BaseForm = ({
  ...
  <section
    className={`flex flex-col gap-3 rounded-md bg-white dark:bg-neutral-800 border border-stroke dark:border-strokedark p-6 pt-4 transition-opacity duration-200 ${className}`}
  >
    {children}
  </section>
);
    ...
    >
      <div className="flex items-center justify-between gap-4">
        <div className="flex grow items-center gap-2">
          <Icon
            className="h-6 w-6 dark:text-neutral-300 text-boxdark-2"
            aria-hidden="true"
          />
          <input
            type="text"
            className="block w-full text-lg font-semibold tracking-wide text-gray-900 outline-none hover:border-gray-300 hover:shadow-sm focus:border-gray-300 focus:shadow-sm bg-transparent border border border-stroke dark:border-strokedark  dark:text-neutral-300"
            value={heading}
