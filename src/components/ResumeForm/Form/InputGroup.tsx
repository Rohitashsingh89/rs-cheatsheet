...
export const InputGroupWrapper = ({
  ...
  <label
    className={`text-base font-medium text-boxdark-2 dark:text-neutral-300 ${className}`}
  >
    {label}
    {children}
  </label>
...
export const INPUT_CLASS_NAME =
  "mt-1 px-3 py-2 block w-full rounded-md border border-stroke dark:border-strokedark bg-transparent border-gray-300 dark:text-white text-boxdark-2 shadow-sm outline-none font-normal text-base";
