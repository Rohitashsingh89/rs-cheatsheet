...
const Selection = ({
  ...
  return (
    <div
      className="flex w-[105px] cursor-pointer items-center justify-center rounded-md border border-stroke py-1.5 shadow-sm dark:border-strokedark hover:bg-gray-100"
      onClick={onClick}
