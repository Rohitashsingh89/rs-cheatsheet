        ...
        <div className="fixed right-3 top-1/4 z-40 flex items-center">
          <Popover className="relative">
            {({ open }) => (
              <>
                <Popover.Button
                  className={`p-2.5 bg-white hover:bg-neutral-100 dark:bg-ten dark:hover:bg-ten-hover rounded-xl shadow-xl border border-neutral-200 dark:border-ten z-10 focus:outline-none ${
                    open ? " focus:ring-2 ring-ten-dark" : ""
                  }`}
                >
